Nice — I’ll preserve the full checklists for Phases 1–3 and keep the Phase 4 checklist (updated). Below is the updated MDX content preview with all previous phase checklists retained exactly and Phase 4 expanded. Review it and tell me if you want me to save it (default filename: ROADMAP.mdx) or change anything.
...
- [ ] Coverage reporting (jest --coverage + Codecov) — Status: Pending — Owner: Dev — ETA: 1 day — Action: add coverage script + upload step, add badge to README.  
...
- Save as `ROADMAP.mdx` in the workspace now, or
- Create a PR patch including this updated roadmap (and optionally include the cart.js/tests/CI patches).

Reply with one of:
- “Save as ROADMAP.mdx” — I’ll write the file.  
- “Create PR” — I’ll prepare the patch and PR message.  
- “Edit” plus details — tell me any edits to checklist owners/ETA/status.